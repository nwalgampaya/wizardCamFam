...
// import CancerInfo from './steps/CancerInfo'
// import downMenu, { downItemGroup, downItem } from '@atlaskit/down-menu';
      ...
      >
        ...
        <Wizard.Page
          validate={values => {
            ...
            if (
              new Date(this.state.currentLKDA) >
              new Date(this.state.currentDeath)
            ) {
              ...
              this.state.currentLKDA == "" &&
              new Date(this.state.dateOfLKDA) >
                new Date(this.state.currentDeath)
            ) {
              errors.currentdodColumn =
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-sm-6">
                                            ...
                                            <div className="col-sm-7">
                                                ...
                                                {/* <DatePicker
>>>>>>> c5dab37024882012c777defc21116d4c5c52156a
